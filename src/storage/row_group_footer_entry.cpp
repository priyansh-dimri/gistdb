...
RowGroupFooterEntry::RowGroupFooterEntry(std::uint32_t table_id, std::uint32_t row_count,
...
const ColumnFooterEntry& RowGroupFooterEntry::Column(std::size_t ordinal) const {
