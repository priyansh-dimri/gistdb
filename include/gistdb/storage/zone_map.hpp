...
class ZoneMap {
 ...
 public:
  ...
  [[nodiscard]] T Min() const;  // pre: HasValues()
  [[nodiscard]] T Max() const;  // pre: HasValues()
...
class VarcharZoneMap {
 public:
  ...
  [[nodiscard]] std::string_view MinPrefix() const;  // pre: HasValues()
  [[nodiscard]] std::string_view MaxPrefix() const;  // pre: HasValues()
  [[nodiscard]] bool HasValues() const { return has_values_; }
